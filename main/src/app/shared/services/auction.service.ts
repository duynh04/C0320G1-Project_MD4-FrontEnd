...
export class AuctionService {
  ...
  closeAuctionById(auctionId: number, status: number, closeTime: string) {
    return this.httpClient.put(this.auctionAPI + `/${auctionId}`, {status, closeTime}, this.httpOptions);
  }
  ...
  searchAuctionsAtHomePage(productName: string, price: string, categoryName: string): Observable<Auction[]> {
    return this.httpClient.get<Auction[]>(this.API_URL + '/home/search', {
      params: {
